...
#define NUM_STREAM_BLOCKS 1
#define NUM_STREAMS 4
#define CONCURRENT_STREAMS 4

#define RUN_SIZE NUM_STREAMS*NUM_STREAM_BLOCKS*BLOCKS*BLOCKS*GPU_BATCHSIZE*THREADS_PER_BLOCK_X*THREADS_PER_BLOCK_Y
